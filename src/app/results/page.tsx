...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Real results from real Blackheath clients. Read genuine KD Personal Training reviews on Google — fat loss, strength, post-injury comebacks and midlife training wins since 2018.",
  path: "/results/",
});
