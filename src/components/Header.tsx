...
/* Solid noir bar with the prototype's lockup: mark + wordmark + strapline.
   No backdrop-blur here: it would become the containing block for the
   MobileNav panel and collapse it. */
      ...
      <div className="mx-auto flex h-[72px] max-w-7xl items-center gap-6 px-4 sm:px-6 lg:h-[84px] xl:gap-8">
        ...
        >
          ...
          <Image
            ...
            height={182}
            priority
            className="h-[26px] w-auto sm:h-[32px] lg:h-[40px]"
          />
        </Link>
